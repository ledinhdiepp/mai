<?php
    ...
    if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
        ...
        $money = number_format($grand_total,2);
        $sql = "INSERT INTO mua_hang(id_tai_khoan,sp,ten,email,phone,price,dia_chi,pmode)
        VALUES ('$id_login1','$products','$name','$email','$phone','$money','$address','$pmode');";
