  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <ul>
          ...
          <li class="#xe"><a href="sanpham.php">XE VINFAST</a></li>
          <li><a href="#services">BẢNG GIÁ</a></li>
          <li><a href="about-notavailable.php">TIN TỨC</a></li>
          <li><a href="#"<?php if(isset($_SESSION['id_login'])){echo"onclick=\"showChat()\"";}?>>LIÊN HỆ</a></li>
          <li class="nav-item" >
          ...
          <li  <?php if(!isset($_SESSION['type_login'])){ echo "style=\"display:none\"";} ?> class="drop-down"><a href=""><i class="icofont-user-male"></i></a>
            <ul>
              ...
              <li><a href="user_view_shopping.php" <?php if(!isset($_SESSION['type_login']) or ($_SESSION['type_login']!=1) or !check_info()){ echo "style=\"display:none\"";} ?> ><i class="icofont-shopify"></i></i> SẢN PHẨM ĐÃ MUA </a></a></li>
          ...
          <li>
          <li>
        <a <?php if(!isset($_SESSION['type_login']) or ($_SESSION['type_login']!=1) or !check_info()){ echo "style=\"display:none\"";} ?> href="cart.php" class="twitter"><i class="icofont-cart"></i> <span id="cart-item" class="badge badge-danger">
                        <?php 
